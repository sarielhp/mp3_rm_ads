...
func buildServerSubcommands(opts *CLIOptions, action *string, countVal, keepVal *int) []clihelp.Command {
	cmds := []clihelp.Command{
		buildServerScanSubcommand(opts, action, countVal),
		buildServerNewSubcommand(opts, action, countVal),
		buildServerListSubcommand(opts, action),
		buildServerDownloadSubcommand(opts, action, countVal, keepVal),
		buildServerKeepSubcommand(opts, action, keepVal),
...
func buildServerNewSubcommand(opts *CLIOptions, action *string, countVal *int) clihelp.Command {
	return clihelp.Command{
		Name:        "new",
...
func buildServerDownloadSubcommand(opts *CLIOptions, action *string, countVal, keepVal *int) clihelp.Command {
	return clihelp.Command{
		...
		Parameters:  []clihelp.Param{{Name: "[<number>]", Description: "Optional number of undownloaded episodes to download (defaults to 1)"}},
		Args:        clihelp.MaximumNArgs(1),
		Options: []clihelp.Option{
...
func buildServerKeepSubcommand(opts *CLIOptions, action *string, keepVal *int) clihelp.Command {
	return clihelp.Command{
		Name:        "keep",
