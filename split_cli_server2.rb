...
part1 = lines[0...idx]
part2 = lines[idx..-7]
part1_end = "\t}\n\n\tc.Subcommands = append(c.Subcommands, buildServerSubcommands2(opts, action, keepVal)...)\n\treturn c\n}\n"
File.write('cli_server_cmds.go', part1.join + part1_end)

part2_full = "package main\n\nimport (\n\t\"github.com/sarielhp/clihelp\"\n)\n\nfunc buildServerSubcommands2(opts *CLIOptions, action *string, keepVal *int) []clihelp.Command {\n\treturn []clihelp.Command{\n" + part2.join + "\t}\n}\n"
