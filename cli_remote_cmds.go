...
func buildRemoteSyncSubcommands(opts *CLIOptions, action *string) []clihelp.Command {
	return []clihelp.Command{
		buildRemoteDeploySubcommand(opts, action),
		buildRemotePushSubcommand(opts, action),
		buildRemotePullSubcommand(opts, action),
		buildRemoteScanSubcommand(opts, action),
	}
}

func buildRemoteDeploySubcommand(opts *CLIOptions, action *string) clihelp.Command {
	return clihelp.Command{
		Name:        "deploy",
...
func buildRemotePushSubcommand(opts *CLIOptions, action *string) clihelp.Command {
	return clihelp.Command{
		Name:        "push",
...
func buildRemotePullSubcommand(opts *CLIOptions, action *string) clihelp.Command {
	return clihelp.Command{
		Name:        "pull",
...
func buildRemoteScanSubcommand(opts *CLIOptions, action *string) clihelp.Command {
	return clihelp.Command{
		Name:        "scan",
...
func buildRemoteWorkerSubcommands(opts *CLIOptions, action *string) []clihelp.Command {
	return []clihelp.Command{
		{
			Name:        "start",
...
func buildRemoteControlSubcommands(opts *CLIOptions, action *string) []clihelp.Command {
	return []clihelp.Command{
		buildRemoteStatusSubcommand(opts, action),
		buildRemoteClearSubcommand(opts, action),
		buildRemoteStopSubcommand(opts, action),
		buildRemoteCancelSubcommand(opts, action),
	}
}

func buildRemoteStatusSubcommand(opts *CLIOptions, action *string) clihelp.Command {
	return clihelp.Command{
		Name:        "status",
...
func buildRemoteClearSubcommand(opts *CLIOptions, action *string) clihelp.Command {
	return clihelp.Command{
		Name:        "clear",
...
func buildRemoteStopSubcommand(opts *CLIOptions, action *string) clihelp.Command {
	return clihelp.Command{
		Name:        "stop",
...
func buildRemoteCancelSubcommand(opts *CLIOptions, action *string) clihelp.Command {
	return clihelp.Command{
		Name:        "cancel",
